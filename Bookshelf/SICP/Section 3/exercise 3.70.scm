...
(define (weight2 s)
  (+ (* 2 (car s)) (* 3 (cadr s)) (* 5 (car s) (cadr s))))
(define not-235
  (stream-filter (lambda (x) (not (or (= (remainder x 2) 0) (= (remainder x 3) 0) (= (remainder x 5) 0))))
                 integers))


(display-stream (weighted-pairs integers integers weight1))

(display-stream (weighted-pairs not-235 not-235 weight2))